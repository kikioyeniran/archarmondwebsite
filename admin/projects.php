...
if (isset($_POST['insert'])) {
    ...
    $query = "INSERT INTO Projects(name,description,client,picture) Values ('$name', '$description', '$client', '$image')";
                        ...
                        <div class="card-body">
                            <form method="post" action="Projects.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" type="text" class="form-control" name="client">
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="metric-value d-inline-block">
                                    <h4 class="mb-1">CLient: <?php echo $row['client']; ?></h4>
                                </div>
                                <div>
                            ...
                            <div class="card-body bg-light">
                                <div id="sparkline-1"><?php echo $row['client']; ?></div>
